...
namespace TTEngine.Editor.Models.Validation
{
    ...
    {
        public static bool CanPlaceObject(TTEngine.Editor.Models.Scene.Scene scene, int x, int y)
        {
            var map = scene.Map;
        ...
        private static bool IsOccupied(TTEngine.Editor.Models.Scene.Scene scene, int x, int y)
        {
        ...
        //Full Map Validation
        public static EditorValidationResult ValidateMap(TTEngine.Editor.Models.Scene.Scene scene)
        {
